...
import { AnyES1Object, AnyES1Null } from '../ECMAScript';
import { ES1Value } from '../../ES1Value';

export class ES1Reference<Representation> extends ES1Type<Representation> {
  constructor(
    public readonly makeReference: (baseObject: AnyES1Object | AnyES1Null , propertyName: string) => Representation
  ) {
    super();
  }
}
...
type NaiveES1ListRepresentationCalculus<Representation> = [
  (baseObject: AnyES1Object | AnyES1Null, propertyName: string) => Representation
]
...
class NaiveES1ReferenceRepresentation {
  constructor(public readonly baseObject: AnyES1Object | AnyES1Null, public readonly propertyName: string) {}
}
